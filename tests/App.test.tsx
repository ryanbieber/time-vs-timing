...
describe('App', () => {
  ...
  it('shows the immediate bundled-SPY comparison and local-only promise', async () => {
    ...
    expect(screen.getByRole('heading', { name: 'How long could you be underwater?' })).toBeInTheDocument()
    expect(screen.getByText('The hardest historical SPY entry was 2000-03-24')).toBeInTheDocument()
    expect(screen.getByText(/6 years 7 months 2 days later/)).toBeInTheDocument()
